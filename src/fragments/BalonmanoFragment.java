//Esta es la pestaña de Balonmano de la parte de gestión
...
import balonmano.PantallaGestionTorneoBalonmano;

import com.actionbarsherlock.app.SherlockFragment;
import com.example.gestliga.PantallaInicial;
import com.example.gestliga.R;

import fragments.FutbolFragment.DatePickerDialogFragment;
import futbol.PantallaGestionTorneo;

public class BalonmanoFragment extends SherlockFragment implements OnItemSelectedListener, OnDateSetListener {
	...
	ArrayList<PosBalonmano> lista_posiciones = new ArrayList<PosBalonmano>();
	Torneo torneo;
	Equipo equipo;
	Jugador jugador;
	LinearLayout ll;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		try{
			v = inflater.inflate(R.layout.balonmano_fragment, container, false);
			//Se asignan las referencias de las vistas en el layout
			spnOrdenar = (Spinner) v.findViewById(R.id.spnOrdenarPor_BM);
			spnMenu = (Spinner) v.findViewById(R.id.spnMenuBM);
			...
			btnCrear = (Button) v.findViewById(R.id.btnCrearBM);
  ...
  //Método para el evento Click del Spinner principal
    ...
    private void crearTorneo(View v){
    	...
    	//creado para la creación de un torneo de balonmano, y agregamos las referencias de las vistas con el layout
    	LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.balonmano_torneo_crear, null);
		edtNombreTorneo = (EditText) ll.findViewById(R.id.edtBMNombreTorneo);
		...
		edtLugarTorneo = (EditText) ll.findViewById(R.id.edtBMLugarTorneo);
		...
		txtFechaInicioTorneo = (TextView) ll.findViewById(R.id.txtBMFechaInicioTorneo);
		txtFechaFinTorneo = (TextView) ll.findViewById(R.id.txtBMFechaFinTorneo);
		btnSeleccionarFechaInicio = (ImageButton) ll.findViewById(R.id.btnBMFechaInicio);
		btnSeleccionarFechaInicio.setOnClickListener(new View.OnClickListener() {
	        ...
	        public void onClick(View v) {
                ...
                DialogFragment newFragment = new DatePickerDialogFragment(BalonmanoFragment.this);
                newFragment.show(ft, "date_picker_dialog");
	        }

	    });
		btnSeleccionarFechaFin = (ImageButton) ll.findViewById(R.id.btnBMFechaFin);
				...
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						if(guardar == false){
							...
							Torneo t = new Torneo(id_torneo, nombreTorneo, lugarTorneo, fechaInicio, fechaFin, 5, 0);
  ...
  //Este método sirve para mostrar la tabla de todos los torneos de balonmano existentes en la BD
    private void construirTablaTorneos(){
    	tablaTorneosContent.removeAllViews();
    	int position = 0;
    	lista_torneos = PantallaInicial.bd.obtenerTorneos(orden, 5);
    	...
    	while(it.hasNext()){
    		...
    		Torneo t = it.next();
    		LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    		TableRow fila = (TableRow) inflater.inflate(R.layout.balonmano_torneos_table_row, null);
    		TextView nombre = (TextView) fila.findViewById(R.id.txtNombreBMTorneo);
    		nombre.setText(t.getNom());
    		TextView numEquipos = (TextView) fila.findViewById(R.id.txtEquiposBMTorneo);
    		numEquipos.setText(t.getNumEquipos()+"");
    		TextView fechaI = (TextView) fila.findViewById(R.id.txtFechaInicioBMTorneos);
    		fechaI.setText(t.getFin());
    		TextView fechaF = (TextView) fila.findViewById(R.id.txtFechaFinBMTorneos);
    		...
    		btnVer.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View vi) {
					if (vi != null) {
						...
						LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
						LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.balonmano_torneo_ver, null);
						...
						LinearLayout llEquipos = (LinearLayout) ll.findViewById(R.id.llBMEquiposInscritosTorneo);
						int n = 1;
						while(aux.hasNext()){
    		...
    		btnModificar.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (v != null) {
						...
						LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
						ll = (LinearLayout) inflater.inflate(R.layout.balonmano_torneo_modificar, null);
						...
						btnSeleccionarFechaInicioMod = (ImageButton) ll.findViewById(R.id.btnModBMFechaInicio);
						...
						btnSeleccionarFechaFinMod = (ImageButton) ll.findViewById(R.id.btnModBMFechaFin);
    		...
    		btnGestionar.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					int tag = Integer.parseInt(v.getTag()+"");
					Intent intent = new Intent(getActivity(), PantallaGestionTorneoBalonmano.class);
    ...
    private void crearEquipo(View v){
    	LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.balonmano_equipo_crear, null);
		edtNombreEquipo = (EditText) ll.findViewById(R.id.edtBMNombreEquipo);
		...
		edtCiudadEquipo = (EditText) ll.findViewById(R.id.edtBMCiudadEquipo);
		...
		edtEstadioEquipo = (EditText) ll.findViewById(R.id.edtBMEstadioEquipo);
		...
		edtFechaFundacionEquipo = (EditText) ll.findViewById(R.id.edtBMFechaFundacionEquipo);
		...
		edtNumSociosEquipo = (EditText) ll.findViewById(R.id.edtBMNumSociosEquipo);
				...
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						if(guardar == false){
							...
							Equipo e = new Equipo(id_equipo, nombreEquipo, fechaFundacionEquipo, numSociosEquipo, estadioEquipo, 5, ciudadEquipo, 0);
    ...
    private void construirTablaEquipos(){
    	...
    	int position = 0;
    	lista_equipos = PantallaInicial.bd.obtenerEquipos(orden, 5);
    	Iterator<Equipo> it = lista_equipos.iterator();
    	while(it.hasNext()){
    		Equipo e = it.next();
    		if(e.getId()!=0){
	    		LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
	    		TableRow fila = (TableRow) inflater.inflate(R.layout.balonmano_equipos_table_row, null);
	    		TextView nombre = (TextView) fila.findViewById(R.id.txtNombreBMEquipos);
	    		nombre.setText(e.getNom());
	    		TextView numJugadores = (TextView) fila.findViewById(R.id.txtNumJugadoresBMEquipos);
	    		numJugadores.setText(e.getNumJugadores()+"");
	    		TextView numSocios = (TextView) fila.findViewById(R.id.txtSociosBMEquipos);
	    		numSocios.setText(e.getSoc()+"");
	    		TextView ciudad = (TextView) fila.findViewById(R.id.txtCiudadBMEquipos);
	    		...
	    		btnVer.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						if (v != null) {
							...
							LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
							LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.balonmano_equipos_ver, null);
	    		...
	    		btnModificar.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						if (v != null) {
							...
							LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
							ll = (LinearLayout) inflater.inflate(R.layout.balonmano_equipos_modificar, null);
  ...
  //Este método permite crear un nuevo jugador en la BD. La forma de proceder es similar a crearTorneo y crearEquipo
	private void crearJugador(View v){
    	LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.balonmano_jugadores_crear, null);
		edtNombreJugador = (EditText) ll.findViewById(R.id.edtBMNombreJugador);
		...
		edtApodoJugador = (EditText) ll.findViewById(R.id.edtBMApodoJugador);
		...
		txtFechaNacJugador = (TextView) ll.findViewById(R.id.txtBMFechaNacJugadorSeleccionada);
		btnSeleccionarFechaNacJugador = (ImageButton) ll.findViewById(R.id.btnBMFechaNacJugador);
		...
		spnPosicionJugador = (Spinner) ll.findViewById(R.id.spnBMPosicionJugador);
		ArrayAdapter<CharSequence> adapter = new ArrayAdapter<CharSequence>(v.getContext(), android.R.layout.simple_spinner_item) {
			public View getView(int position, View convertView, ViewGroup parent) {
				View v = super.getView(position, convertView, parent);
		...
		lista_posiciones = PantallaInicial.bd.obtenerPosicionesBalonmano();
		Iterator<PosBalonmano> ip = lista_posiciones.iterator();
		while(ip.hasNext()){
		...
		spnEquipoJugador = (Spinner) ll.findViewById(R.id.spnBMEquipoJugador);
		...
		lista_equipos = PantallaInicial.bd.obtenerEquipos("equ_nom", 5);
				...
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						if(guardar == false){
							...
							Jugador j = new Jugador(id_jugador, nombreJugador, apodoJugador, fechaNacJugador, posicionJugador, 5, equipoJugador);
	...
	private void construirTablaJugadores(){
    	...
    	int position = 0;
    	lista_jugadores = PantallaInicial.bd.obtenerJugadores(orden, 5);
    	Iterator<Jugador> it = lista_jugadores.iterator();
    	while(it.hasNext()){
    		Jugador j = it.next();
    		LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    		TableRow fila = (TableRow) inflater.inflate(R.layout.balonmano_jugadores_table_row, null);
    		TextView nombre = (TextView) fila.findViewById(R.id.txtNombreBMJugadores);
    		nombre.setText(j.getNom());
    		TextView apodo = (TextView) fila.findViewById(R.id.txtApodoBMJugadores);
    		apodo.setText(j.getApo());
    		
    		TextView edad = (TextView) fila.findViewById(R.id.txtEdadBMJugadores);
    		...
    		TextView posicion = (TextView) fila.findViewById(R.id.txtPosicionBMJugadores);
    		posicion.setText(PantallaInicial.bd.obtenerPosicionFutbol(j.getPos()).getAbr());
    		TextView equipo_jug = (TextView) fila.findViewById(R.id.txtEquipoBMJugadores);
    		...
    		btnVer.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (v != null) {
						...
						LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
						LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.balonmano_jugadores_ver, null);
    		...
    		btnModificar.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (v != null) {
						...
						LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
						ll = (LinearLayout) inflater.inflate(R.layout.balonmano_jugadores_modificar, null);
						...
						btnSeleccionarFechaNacJugadorMod = (ImageButton) ll.findViewById(R.id.btnModBMFechaNac);
						...
						spnModEquipoJugador = (Spinner) ll.findViewById(R.id.spnModBMEquipoJugador);
						adapter = new ArrayAdapter<CharSequence>(v.getContext(), android.R.layout.simple_spinner_item) {
							public View getView(int position, View convertView, ViewGroup parent) {
								View v = super.getView(position, convertView, parent);
