...
import com.example.gestliga.R.id;
...
public class TenisFragment extends SherlockFragment implements OnItemSelectedListener, OnDateSetListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		try {
			v = inflater.inflate(R.layout.tenis_fragment, container, false);
			//Se asignan las referencias de las vistas en el layout
			spnOrdenar = (Spinner) v.findViewById(R.id.spnOrdenarPor_Tenis);
			spnMenu = (Spinner) v.findViewById(R.id.spnMenuTenis);
			...
			tablaTorneos = (TableLayout) v.findViewById(R.id.tablaTorneosTenis);
			tablaJugadores = (TableLayout) v.findViewById(R.id.tablaJugadoresTenis);
			tablaTorneosContent = (TableLayout) v.findViewById(R.id.tablaTorneosContentTenis);
			tablaJugadoresContent = (TableLayout) v.findViewById(R.id.tablaJugadoresContentTenis);
			...
			btnCrear = (Button) v.findViewById(R.id.btnCrearTenis);
	...
	private void crearTorneo(View v) {
    	...
    	//creado para la creación de un torneo de tenis, y agregamos las referencias de las vistas con el layout
		LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.tenis_torneo_crear, null);
		edtNombreTorneo = (EditText) ll.findViewById(R.id.edtTenisNombreTorneo);
		...
		edtLugarTorneo = (EditText) ll.findViewById(R.id.edtTenisLugarTorneo);
		...
		txtFechaInicioTorneo = (TextView) ll.findViewById(R.id.txtTenisFechaInicioTorneo);
		txtFechaFinTorneo = (TextView) ll.findViewById(R.id.txtTenisFechaFinTorneo);
		btnSeleccionarFechaInicio = (ImageButton) ll.findViewById(R.id.btnTenisFechaInicio);
		btnSeleccionarFechaInicio.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				DialogFragment newFragment = new DatePickerDialogFragment(TenisFragment.this);
				newFragment.show(ft, "date_picker_dialog");
			}

		});
		btnSeleccionarFechaFin = (ImageButton) ll.findViewById(R.id.btnTenisFechaFin);
		...
		builder.setPositiveButton(getString(R.string.crear), new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if (guardar == false) {
					...
					Torneo t = new Torneo(id_torneo, nombreTorneo, lugarTorneo, fechaInicio, fechaFin, 2, 0);
	...
	//Este método sirve para mostrar la tabla de todos los torneos de tenis existentes en la BD
	private void construirTablaTorneos() {
		tablaTorneosContent.removeAllViews();
		int position = 0;
		lista_torneos = PantallaInicial.bd.obtenerTorneosTenis(orden);
		...
		while (it.hasNext()) {
			...
			LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			TableRow fila = (TableRow) inflater.inflate(R.layout.tenis_torneos_table_row, null);
			TextView nombre = (TextView) fila.findViewById(R.id.txtNombreTenisTorneo);
			nombre.setText(t.getNom());
			TextView numJugadores = (TextView) fila.findViewById(R.id.txtJugadoresTenisTorneo);
			numJugadores.setText(t.getNumJugadores() + "");
			TextView fechaI = (TextView) fila.findViewById(R.id.txtFechaInicioTenisTorneos);
			fechaI.setText(t.getFin());
			TextView fechaF = (TextView) fila.findViewById(R.id.txtFechaFinTenisTorneos);
			...
			btnVer.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View vi) {
					if (vi != null) {
						...
						LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
						LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.tenis_torneo_ver, null);
						txtVerNombreTorneo = (TextView) ll.findViewById(R.id.txtVerTorneoNombreTenis);
						txtVerNombreTorneo.setText(t.getNom());

						txtVerLugarTorneo = (TextView) ll.findViewById(R.id.txtVerTorneoLugarTenis);
						txtVerLugarTorneo.setText(t.getLug());

						txtVerNumJugadores = (TextView) ll.findViewById(R.id.txtVerTorneoNumJugadoresTenis);
						txtVerNumJugadores.setText(t.getNumJugadores() + "");

						txtVerFechaI = (TextView) ll.findViewById(R.id.txtVerTorneoFechaITenis);
						txtVerFechaI.setText(t.getFin());

						txtVerFechaF = (TextView) ll.findViewById(R.id.txtVerTorneoFechaFTenis);
						txtVerFechaF.setText(t.getFfi());

						txtVerDeporte = (TextView) ll.findViewById(R.id.txtVerTorneoDeporteTenis);
						...
						LinearLayout llJugadores = (LinearLayout) ll.findViewById(R.id.llTenisJugadoresInscritosTorneo);
						int n = 1;
						while (aux.hasNext()) {
			...
			btnModificar.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (v != null) {
						...
						LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
						ll = (LinearLayout) inflater.inflate(R.layout.tenis_torneo_modificar, null);
						edtModNombreTorneo = (EditText) ll.findViewById(R.id.edtModTorneoNombreTenis);
						...
						edtModLugarTorneo = (EditText) ll.findViewById(R.id.edtModTorneoLugarTenis);
						...
						txtModFechaITorneo = (TextView) ll.findViewById(R.id.txtModTorneoFechaITenis);
						txtModFechaITorneo.setText(torneo.getFin());
						fechaInicio = torneo.getFin();
						txtModFechaFTorneo = (TextView) ll.findViewById(R.id.txtModTorneoFechaFTenis);
						txtModFechaFTorneo.setText(torneo.getFfi());
						fechaFin = torneo.getFfi();
						btnSeleccionarFechaInicioMod = (ImageButton) ll.findViewById(R.id.btnModFechaInicioTenis);
						...
						btnSeleccionarFechaFinMod = (ImageButton) ll.findViewById(R.id.btnModFechaFinTenis);
						...
						builder.setPositiveButton(getString(R.string.modificar), new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int which) {
								...
								if (guardar == false) {
									...
									TorneoTenis original = PantallaInicial.bd.obtenerTorneoTenis(id_torneo_modificar);
			...
			btnGestionar.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					int tag = Integer.parseInt(v.getTag()+"");
					Intent intent = new Intent(getActivity(), PantallaGestionTorneoTenis.class);
	...
	private void crearJugador(View v) {
		LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.tenis_jugadores_crear, null);
		edtNombreJugador = (EditText) ll.findViewById(R.id.edtTenisNombreJugador);
		...
		edtApodoJugador = (EditText) ll.findViewById(R.id.edtTenisApodoJugador);
		...
		txtFechaNacJugador = (TextView) ll.findViewById(R.id.txtTenisFechaNacJugadorSeleccionada);
		btnSeleccionarFechaNacJugador = (ImageButton) ll.findViewById(R.id.btnTenisFechaNacJugador);
		...
		builder.setPositiveButton(getString(R.string.crear), new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if (guardar == false) {
					...
					Jugador j = new Jugador(id_jugador, nombreJugador, apodoJugador, fechaNacJugador, -1, 2, 0);
	...
	private void construirTablaJugadores() {
		...
		int position = 0;
		lista_jugadores = PantallaInicial.bd.obtenerJugadores(orden, 2);
		Log.d("NumJugadores",lista_jugadores.size()+"");
		Iterator<Jugador> it = lista_jugadores.iterator();
		while (it.hasNext()) {
			Jugador j = it.next();
			LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			TableRow fila = (TableRow) inflater.inflate(R.layout.tenis_jugadores_table_row, null);
			TextView nombre = (TextView) fila.findViewById(R.id.txtNombreTenisJugadores);
			nombre.setText(j.getNom());
			TextView apodo = (TextView) fila.findViewById(R.id.txtApodoTenisJugadores);
			apodo.setText(j.getApo());
			TextView edad = (TextView) fila.findViewById(R.id.txtEdadTenisJugadores);
			...
			btnVer.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (v != null) {
						...
						LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
						LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.tenis_jugadores_ver, null);
						txtVerNombreJugador = (TextView) ll.findViewById(R.id.txtVerJugadorNombreTenis);
						txtVerNombreJugador.setText(j.getNom());

						txtVerApodoJugador = (TextView) ll.findViewById(R.id.txtVerJugadorApodoTenis);
						txtVerApodoJugador.setText(j.getApo());

						txtVerFechaNacJugador = (TextView) ll.findViewById(R.id.txtVerJugadorFechaNacTenis);
			...
			btnModificar.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (v != null) {
						...
						LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
						ll = (LinearLayout) inflater.inflate(R.layout.tenis_jugadores_modificar, null);
						edtModNombreJugador = (EditText) ll.findViewById(R.id.edtModJugadorNombreTenis);
						...
						edtModApodoJugador = (EditText) ll.findViewById(R.id.edtModJugadorApodoTenis);
						...
						txtModFechaNacJugador = (TextView) ll.findViewById(R.id.txtModJugadorFechaNacTenis);
						txtModFechaNacJugador.setText(jugador.getFna());
						fechaNacJugador = jugador.getFna();
						btnSeleccionarFechaNacJugadorMod = (ImageButton) ll.findViewById(R.id.btnModTenisFechaNac);
