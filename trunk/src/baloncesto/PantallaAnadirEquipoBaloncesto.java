//Esta actividad es para añadir equipos a un torneo de baloncesto
...
public class PantallaAnadirEquipoBaloncesto extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.baloncesto_activity_pantalla_anadir_equipo);
	
		//Se asignan las referencias de las vistas en el layout
		btnAnadir = (Button) findViewById(R.id.btnGuardarGestionTorneoAnadirEquipoBC);
		...
		llAnadir = (LinearLayout) findViewById(R.id.llBCGestionTorneoEquiposSeleccionados);
		llBuscar = (LinearLayout) findViewById(R.id.llBCGestionTorneoEquiposBuscar);
		edtBuscar = (EditText) findViewById(R.id.edtGestionTorneoBuscarBC);
	...
	private void cargarEquipos(){
		...
		lista_equipos.clear();
		lista_equipos = PantallaInicial.bd.obtenerEquiposPorNombre(buscar, 3, getIntent().getIntExtra("id_torneo",-1));
		...
		while(it.hasNext()){
			...
			if(lista_equipos_seleccionados.indexOf(equipo.getId())<0){
				...
				LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.baloncesto_fila_buscar_equipo, null);
				TextView txtEquipo = (TextView) ll.findViewById(R.id.txtGestionTorneoAnadirEquipoFilaEquipoBC);
				txtEquipo.setText(equipo.getNom());
				ImageButton img = (ImageButton) ll.findViewById(R.id.imgGestionTorneoAnadirEquipoFilaEquipoBC);
	...
	private void cargarListaSeleccionada(View v){
		...
		LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.baloncesto_fila_anadir_equipo, null);
		TextView txtEquipo = (TextView) ll.findViewById(R.id.txtGestionTorneoAnadirEquipoFilaEquipoEliminarBC);
		txtEquipo.setText(lista_equipos.get(Integer.parseInt(v.getTag()+"")).getNom());
		ImageButton img = (ImageButton) ll.findViewById(R.id.imgGestionTorneoAnadirEquipoFilaEquipoEliminarBC);
