//Esta actividad es para eliminar equipos a un torneo de balonmano
...
public class PantallaEliminarEquiposBalonmano extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.balonmano_activity_pantalla_eliminar_equipos);
		//Se asignan las referencias de las vistas en el layout		
		llEliminar = (LinearLayout) findViewById(R.id.llBMGestionTorneoEquiposEliminar);
		//Se cargan los equipos que están en el torneo
		lista_equipos = PantallaInicial.bd.obtenerEquiposDeTorneo(getIntent().getIntExtra("id_torneo", -1), 5);
