//Esta actividad sirve para introducir los datos de un partido de tenis
...
public class PantallaGestionPartidoTenis extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tenis_activity_pantalla_gestion_partido);
