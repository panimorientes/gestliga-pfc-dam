//Esta actividad es para añadir jugadores a un torneo de tenis
...
public class PantallaAnadirJugador extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tenis_activity_pantalla_anadir_jugador);
		...
		llAnadir = (LinearLayout) findViewById(R.id.llTenisGestionTorneoJugadoresSeleccionados);
		llBuscar = (LinearLayout) findViewById(R.id.llTenisGestionTorneoJugadoresBuscar);
		edtBuscar = (EditText) findViewById(R.id.edtGestionTorneoBuscarTenis);
	...
	private void cargarJugadores(){
		...
		lista_jugadores = PantallaInicial.bd.obtenerJugadoresPorNombre(buscar, 2, getIntent().getIntExtra("id_torneo", -1));
		...
		while(it.hasNext()){
			...
			if(lista_jugadores_seleccionados.indexOf(jugador.getId())<0){
				...
				LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.tenis_fila_buscar_jugador, null);
	...
	private void cargarListaSeleccionada(View v){
		...
		LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.tenis_fila_anadir_jugador, null);
