//Esta es la pestaña de Fútbol de la parte de gestión
...
import com.example.gestliga.PantallaGestionPrincipal;
import com.example.gestliga.PantallaInicial;
import com.example.gestliga.R;

import futbol.PantallaGestionTorneo;

public class FutbolFragment extends SherlockFragment implements OnItemSelectedListener, OnDateSetListener{
	private Spinner spnMenu, spnOrdenar,
					 spnPosicionJugador, spnEquipoJugador, 
					 spnModPosicionJugador, spnModEquipoJugador;
	private TableLayout tablaTorneos, tablaEquipos, tablaJugadores, tablaTorneosContent, tablaEquiposContent, tablaJugadoresContent;
	private Button btnCrear;
	private EditText edtNombreTorneo, edtLugarTorneo,
					 edtModNombreTorneo, edtModLugarTorneo,
					 edtNombreEquipo, edtCiudadEquipo, edtEstadioEquipo, edtFechaFundacionEquipo, edtNumSociosEquipo,
					 edtModNombreEquipo, edtModCiudadEquipo, edtModEstadioEquipo, edtModFechaFundacionEquipo, edtModNumSociosEquipo,
	...
	private TextView txtFechaInicioTorneo, txtFechaFinTorneo, 
					 txtVerNombreTorneo, txtVerLugarTorneo, txtVerNumEquipos, txtVerFechaI, txtVerFechaF, txtVerDeporte,
					 txtModFechaITorneo, txtModFechaFTorneo,
					 txtVerNombreEquipo, txtVerCiudadEquipo, txtVerEstadioEquipo, txtVerFechaFundacionEquipo,
					 txtVerNumSociosEquipo, txtVerDeporteEquipo,
					 txtVerNombreJugador, txtVerApodoJugador, txtVerFechaNacJugador, txtVerEquipoJugador, txtVerPosicionJugador,
					 txtFechaNacJugador,
					 txtModFechaNacJugador;
	...
	private ImageButton btnSeleccionarFechaInicio, btnSeleccionarFechaFin,
						...
						btnSeleccionarFechaNacJugador,
						btnSeleccionarFechaNacJugadorMod;
	
	private int fecha;
	private String tituloDialogo;
	
	private String nombreTorneo, lugarTorneo, fechaInicio, fechaFin, orden="",
				   nombreEquipo, ciudadEquipo, estadioEquipo,
				   nombreJugador, apodoJugador, fechaNacJugador;
	private int fechaFundacionEquipo, numSociosEquipo,
				posicionJugador, equipoJugador;
	int id_torneo, deporte, id_torneo_modificar, id_equipo, id_equipo_modificar, id_jugador, id_jugador_modificar;
	...
	ArrayList<PosFutbol> lista_posiciones = new ArrayList<PosFutbol>();
	Torneo torneo;
	Equipo equipo;
	Jugador jugador;
	LinearLayout ll;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		try{
			v = inflater.inflate(R.layout.futbol_fragment, container, false);
			//Se asignan las referencias de las vistas en el layout
			spnOrdenar = (Spinner) v.findViewById(R.id.spnOrdenarPor_Futbol);
			spnMenu = (Spinner) v.findViewById(R.id.spnMenuFutbol);
			...
			tablaTorneos = (TableLayout) v.findViewById(R.id.tablaTorneos);
			tablaEquipos = (TableLayout) v.findViewById(R.id.tablaEquipos);
			tablaJugadores = (TableLayout) v.findViewById(R.id.tablaJugadores);
			tablaTorneosContent = (TableLayout) v.findViewById(R.id.tablaTorneosContent);
			tablaEquiposContent = (TableLayout) v.findViewById(R.id.tablaEquiposContent);
			tablaJugadoresContent = (TableLayout) v.findViewById(R.id.tablaJugadoresContent);
			
			btnCrear = (Button) v.findViewById(R.id.btnCrearFutbol);
    ...
    private void crearTorneo(View v){
    	...
    	//creado para la creación de un torneo de fútbol, y agregamos las referencias de las vistas con el layout
    	LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.futbol_torneo_crear, null);
		edtNombreTorneo = (EditText) ll.findViewById(R.id.edtFutbolNombreTorneo);
		...
		edtLugarTorneo = (EditText) ll.findViewById(R.id.edtFutbolLugarTorneo);
		...
		txtFechaInicioTorneo = (TextView) ll.findViewById(R.id.txtFutbolFechaInicioTorneo);
		txtFechaFinTorneo = (TextView) ll.findViewById(R.id.txtFutbolFechaFinTorneo);
		btnSeleccionarFechaInicio = (ImageButton) ll.findViewById(R.id.btnFutbolFechaInicio);
		btnSeleccionarFechaInicio.setOnClickListener(new View.OnClickListener() {
	        ...
	        public void onClick(View v) {
                ...
                DialogFragment newFragment = new DatePickerDialogFragment(FutbolFragment.this);
                newFragment.show(ft, "date_picker_dialog");
	        }

	    });
		btnSeleccionarFechaFin = (ImageButton) ll.findViewById(R.id.btnFutbolFechaFin);
				...
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						if(guardar == false){
							...
							Torneo t = new Torneo(id_torneo, nombreTorneo, lugarTorneo, fechaInicio, fechaFin, 1, 0);
  ...
  //Este método sirve para mostrar la tabla de todos los torneos de fútbol existentes en la BD
    private void construirTablaTorneos(){
    	tablaTorneosContent.removeAllViews();
    	int position = 0;
    	lista_torneos = PantallaInicial.bd.obtenerTorneos(orden, 1);
    	...
    	while(it.hasNext()){
    		...
    		Torneo t = it.next();
    		LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    		TableRow fila = (TableRow) inflater.inflate(R.layout.futbol_torneos_table_row, null);
    		TextView nombre = (TextView) fila.findViewById(R.id.txtNombreFutbolTorneo);
    		nombre.setText(t.getNom());
    		TextView numEquipos = (TextView) fila.findViewById(R.id.txtEquiposFutbolTorneo);
    		numEquipos.setText(t.getNumEquipos()+"");
    		TextView fechaI = (TextView) fila.findViewById(R.id.txtFechaInicioFutbolTorneos);
    		fechaI.setText(t.getFin());
    		TextView fechaF = (TextView) fila.findViewById(R.id.txtFechaFinFutbolTorneos);
    		...
    		btnVer.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View vi) {
					if (vi != null) {
						...
						LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
						LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.futbol_torneo_ver, null);
						txtVerNombreTorneo = (TextView) ll.findViewById(R.id.txtVerTorneoNombre);
						txtVerNombreTorneo.setText(t.getNom());
						
						txtVerLugarTorneo = (TextView) ll.findViewById(R.id.txtVerTorneoLugar);
						txtVerLugarTorneo.setText(t.getLug());
						
						txtVerNumEquipos = (TextView) ll.findViewById(R.id.txtVerTorneoNumEquipos);
						txtVerNumEquipos.setText(t.getNumEquipos()+"");
						
						txtVerFechaI = (TextView) ll.findViewById(R.id.txtVerTorneoFechaI);
						txtVerFechaI.setText(t.getFin());
						
						txtVerFechaF = (TextView) ll.findViewById(R.id.txtVerTorneoFechaF);
						txtVerFechaF.setText(t.getFfi());
						
						txtVerDeporte = (TextView) ll.findViewById(R.id.txtVerTorneoDeporte);
						...
						LinearLayout llEquipos = (LinearLayout) ll.findViewById(R.id.llFutbolEquiposInscritosTorneo);
						int n = 1;
						while(aux.hasNext()){
    		...
    		btnModificar.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (v != null) {
						...
						LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
						ll = (LinearLayout) inflater.inflate(R.layout.futbol_torneo_modificar, null);
						edtModNombreTorneo = (EditText) ll.findViewById(R.id.edtModTorneoNombre);
						...
						edtModLugarTorneo = (EditText) ll.findViewById(R.id.edtModTorneoLugar);
						...
						txtModFechaITorneo = (TextView) ll.findViewById(R.id.txtModTorneoFechaI);
						txtModFechaITorneo.setText(torneo.getFin());
						fechaInicio = torneo.getFin();
						txtModFechaFTorneo = (TextView) ll.findViewById(R.id.txtModTorneoFechaF);
						txtModFechaFTorneo.setText(torneo.getFfi());
						fechaFin = torneo.getFfi();
						btnSeleccionarFechaInicioMod = (ImageButton) ll.findViewById(R.id.btnModFutbolFechaInicio);
						...
						btnSeleccionarFechaFinMod = (ImageButton) ll.findViewById(R.id.btnModFutbolFechaFin);
    		...
    		btnGestionar.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					int tag = Integer.parseInt(v.getTag()+"");
					Intent intent = new Intent(getActivity(), PantallaGestionTorneo.class);
    ...
    private void crearEquipo(View v){
    	LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.futbol_equipo_crear, null);
		edtNombreEquipo = (EditText) ll.findViewById(R.id.edtFutbolNombreEquipo);
		...
		edtCiudadEquipo = (EditText) ll.findViewById(R.id.edtFutbolCiudadEquipo);
		...
		edtEstadioEquipo = (EditText) ll.findViewById(R.id.edtFutbolEstadioEquipo);
		...
		edtFechaFundacionEquipo = (EditText) ll.findViewById(R.id.edtFutbolFechaFundacionEquipo);
		...
		edtNumSociosEquipo = (EditText) ll.findViewById(R.id.edtFutbolNumSociosEquipo);
				...
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						if(guardar == false){
							...
							Equipo e = new Equipo(id_equipo, nombreEquipo, fechaFundacionEquipo, numSociosEquipo, estadioEquipo, 1, ciudadEquipo, 0);
    ...
    private void construirTablaEquipos(){
    	...
    	int position = 0;
    	lista_equipos = PantallaInicial.bd.obtenerEquipos(orden, 1);
    	Iterator<Equipo> it = lista_equipos.iterator();
    	while(it.hasNext()){
    		Equipo e = it.next();
    		if(e.getId()!=0){
	    		LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
	    		TableRow fila = (TableRow) inflater.inflate(R.layout.futbol_equipos_table_row, null);
	    		TextView nombre = (TextView) fila.findViewById(R.id.txtNombreFutbolEquipos);
	    		nombre.setText(e.getNom());
	    		TextView numJugadores = (TextView) fila.findViewById(R.id.txtNumJugadoresFutbolEquipos);
	    		numJugadores.setText(e.getNumJugadores()+"");
	    		TextView numSocios = (TextView) fila.findViewById(R.id.txtSociosFutbolEquipos);
	    		numSocios.setText(e.getSoc()+"");
	    		TextView ciudad = (TextView) fila.findViewById(R.id.txtCiudadFutbolEquipos);
	    		...
	    		btnVer.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						if (v != null) {
							...
							LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
							LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.futbol_equipos_ver, null);
							txtVerNombreEquipo = (TextView) ll.findViewById(R.id.txtVerEquipoNombre);
							txtVerNombreEquipo.setText(e.getNom());
							
							txtVerCiudadEquipo = (TextView) ll.findViewById(R.id.txtVerEquipoCiudad);
							txtVerCiudadEquipo.setText(e.getCiu());
							
							txtVerEstadioEquipo = (TextView) ll.findViewById(R.id.txtVerEquipoEstadio);
							txtVerEstadioEquipo.setText(e.getEst());
							
							txtVerFechaFundacionEquipo = (TextView) ll.findViewById(R.id.txtVerEquipoFechaFundacion);
							txtVerFechaFundacionEquipo.setText(e.getFfu()+"");
							
							txtVerNumSociosEquipo = (TextView) ll.findViewById(R.id.txtVerEquipoSocios);
							txtVerNumSociosEquipo.setText(e.getSoc()+"");
							
							txtVerDeporteEquipo = (TextView) ll.findViewById(R.id.txtVerEquipoDeporte);
	    		...
	    		btnModificar.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						if (v != null) {
							...
							LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
							ll = (LinearLayout) inflater.inflate(R.layout.futbol_equipos_modificar, null);
							edtModNombreEquipo = (EditText) ll.findViewById(R.id.edtModEquipoNombre);
							...
							edtModCiudadEquipo = (EditText) ll.findViewById(R.id.edtModEquipoCiudad);
							...
							edtModEstadioEquipo = (EditText) ll.findViewById(R.id.edtModEquipoEstadio);
							...
							edtModFechaFundacionEquipo = (EditText) ll.findViewById(R.id.edtModEquipoFechaFundacion);
							...
							edtModNumSociosEquipo = (EditText) ll.findViewById(R.id.edtModEquipoNumSocios);
	...
	private void crearJugador(View v){
    	LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.futbol_jugadores_crear, null);
		edtNombreJugador = (EditText) ll.findViewById(R.id.edtFutbolNombreJugador);
		...
		edtApodoJugador = (EditText) ll.findViewById(R.id.edtFutbolApodoJugador);
		...
		txtFechaNacJugador = (TextView) ll.findViewById(R.id.txtFutbolFechaNacJugadorSeleccionada);
		btnSeleccionarFechaNacJugador = (ImageButton) ll.findViewById(R.id.btnFutbolFechaNacJugador);
		...
		spnPosicionJugador = (Spinner) ll.findViewById(R.id.spnFutbolPosicionJugador);
		ArrayAdapter<CharSequence> adapter = new ArrayAdapter<CharSequence>(v.getContext(), android.R.layout.simple_spinner_item) {
			public View getView(int position, View convertView, ViewGroup parent) {
				View v = super.getView(position, convertView, parent);
		...
		lista_posiciones = PantallaInicial.bd.obtenerPosicionesFutbol();
		Iterator<PosFutbol> ip = lista_posiciones.iterator();
		while(ip.hasNext()){
		...
		spnEquipoJugador = (Spinner) ll.findViewById(R.id.spnFutbolEquipoJugador);
		...
		lista_equipos = PantallaInicial.bd.obtenerEquipos("equ_nom", 1);
				...
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						if(guardar == false){
							...
							Jugador j = new Jugador(id_jugador, nombreJugador, apodoJugador, fechaNacJugador, posicionJugador, 1, equipoJugador);
	...
	private void construirTablaJugadores(){
    	...
    	int position = 0;
    	lista_jugadores = PantallaInicial.bd.obtenerJugadores(orden, 1);
    	Iterator<Jugador> it = lista_jugadores.iterator();
    	while(it.hasNext()){
    		Jugador j = it.next();
    		LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    		TableRow fila = (TableRow) inflater.inflate(R.layout.futbol_jugadores_table_row, null);
    		TextView nombre = (TextView) fila.findViewById(R.id.txtNombreFutbolJugadores);
    		nombre.setText(j.getNom());
    		TextView apodo = (TextView) fila.findViewById(R.id.txtApodoFutbolJugadores);
    		apodo.setText(j.getApo());
    		TextView edad = (TextView) fila.findViewById(R.id.txtEdadFutbolJugadores);
    		...
    		TextView posicion = (TextView) fila.findViewById(R.id.txtPosicionFutbolJugadores);
    		posicion.setText(PantallaInicial.bd.obtenerPosicionFutbol(j.getPos()).getAbr());
    		TextView equipo_jug = (TextView) fila.findViewById(R.id.txtEquipoFutbolJugadores);
    		...
    		btnVer.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (v != null) {
						...
						LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
						LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.futbol_jugadores_ver, null);
						txtVerNombreJugador = (TextView) ll.findViewById(R.id.txtVerJugadorNombre);
						txtVerNombreJugador.setText(j.getNom());
						
						txtVerApodoJugador = (TextView) ll.findViewById(R.id.txtVerJugadorApodo);
						txtVerApodoJugador.setText(j.getApo());
						
						txtVerFechaNacJugador = (TextView) ll.findViewById(R.id.txtVerJugadorFechaNac);
						txtVerFechaNacJugador.setText(j.getFna());
						
						txtVerEquipoJugador = (TextView) ll.findViewById(R.id.txtVerJugadorEquipo);
						txtVerEquipoJugador.setText(PantallaInicial.bd.obtenerEquipo(j.getEqu()).getNom());
						
						txtVerPosicionJugador = (TextView) ll.findViewById(R.id.txtVerJugadorPosicion);
						txtVerPosicionJugador.setText(PantallaInicial.bd.obtenerPosicionFutbol(j.getPos()).getDen());
    		...
    		btnModificar.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (v != null) {
						...
						LayoutInflater inflater = (LayoutInflater) v.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
						ll = (LinearLayout) inflater.inflate(R.layout.futbol_jugadores_modificar, null);
						edtModNombreJugador = (EditText) ll.findViewById(R.id.edtModJugadorNombre);
						...
						edtModApodoJugador = (EditText) ll.findViewById(R.id.edtModJugadorApodo);
						...
						txtModFechaNacJugador = (TextView) ll.findViewById(R.id.txtModJugadorFechaNac);
						txtModFechaNacJugador.setText(jugador.getFna());
						fechaNacJugador = jugador.getFna();
						btnSeleccionarFechaNacJugadorMod = (ImageButton) ll.findViewById(R.id.btnModFutbolFechaNac);
						...
						spnModPosicionJugador = (Spinner) ll.findViewById(R.id.spnModJugadorPosicion);
						ArrayAdapter<CharSequence> adapter = new ArrayAdapter<CharSequence>(v.getContext(), android.R.layout.simple_spinner_item) {
							public View getView(int position, View convertView, ViewGroup parent) {
								View v = super.getView(position, convertView, parent);
						...
						spnModEquipoJugador = (Spinner) ll.findViewById(R.id.spnModFutbolEquipoJugador);
						adapter = new ArrayAdapter<CharSequence>(v.getContext(), android.R.layout.simple_spinner_item) {
							public View getView(int position, View convertView, ViewGroup parent) {
								View v = super.getView(position, convertView, parent);
