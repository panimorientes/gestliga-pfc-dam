//Esta actividad es para eliminar jugadores a un torneo de pádel
...
public class PantallaEliminarJugadores extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.padel_activity_pantalla_eliminar_jugadores);
		//Se asignan las referencias de las vistas en el layout
		llEliminar = (LinearLayout) findViewById(R.id.llPadelGestionTorneoJugadoresEliminar);
		//Se cargan los jugadores que están en el torneo
		lista_jugadores = PantallaInicial.bd.obtenerJugadoresDeTorneo(getIntent().getIntExtra("id_torneo", -1), "", 4);
